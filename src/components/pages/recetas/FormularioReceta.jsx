              ...
              <Form.Control
                ...
                {...register("tiempoPrep", {
                  ...
                  min: {
                    value: 1,
                    message:
                      "El tiempo de preparacion debe ser mayor a 1 minuto",
                  },
                  max: {
                    value: 500,
                    message:
                      "El tiempo de preparacion debe ser menor a 500 minutos",
                  },
                })}
              />
              <Form.Text className="text-danger">
                {errors.tiempoPrep?.message}
              </Form.Text>
            </Form.Group>
              ...
              <Form.Control
                ...
                {...register("tiempoCoccion", {
                  ...
                  max: {
                    value: 500,
                    message:
                      "El tiempo de coccion debe ser menor a 500 minutos",
                  },
                })}
              />
              <Form.Text className="text-danger">
              ...
              <Form.Control
                ...
                {...register("porciones", {
                  ...
                  max: {
                    value: 20,
                    message:
                      "La cantidad de porciones debe ser menor o igual a 20",
                  },
                })}
              />
              <Form.Text className="text-danger">
                ...
                <Form.Control
                  ...
                  {...register(`pasos.${posicion}`, {
                    ...
                    minLength: {
                      value: 3,
                      message:
                        "La cantidad de caracteres debe ser mayor o igual a 3",
                    },
                    maxLength: {
                      value: 50,
                      message:
